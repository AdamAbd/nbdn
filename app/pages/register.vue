  ...
  <div class="flex min-h-screen items-center justify-center bg-gray-50/50 p-4 dark:bg-gray-900/50">
    <UiCard class="w-full max-w-md border-0 shadow-xl sm:border sm:shadow-sm">
      <UiCardHeader class="space-y-1 text-center">
        <UiCardTitle class="text-2xl font-bold tracking-tight"> Buat Akun Baru </UiCardTitle>
        <UiCardDescription> Mulai perjalanan Anda bersama kami </UiCardDescription>
      </UiCardHeader>
        ...
        <form id="register-form" class="space-y-4" @submit="onSubmit">
          <UiFieldGroup>
            ...
            <VeeField v-slot="{ field, errors }" name="password">
              <UiField :data-invalid="!!errors.length">
                <UiFieldLabel for="register-form-password">Password</UiFieldLabel>
                <UiInput
